...
<a aria-label="CI Status" href="https://github.com/khulnasoft/style-guide/actions/workflows/quality.yml?query=event%3Apush">
  <img alt="" src="https://img.shields.io/github/workflow/status/khulnasoft/style-guide/Quality?event=push&style=flat-square&labelColor=000000">
</a>
...
```sh
# If you use npm
npm i @khulnasoft/style-guide

# If you use pmpm
pnpm i @khulnasoft/style-guide

# If you use Yarn
yarn add @khulnasoft/style-guide
```
...
```json
{
  "extends": "@khulnasoft/style-guide/typescript"
}
```
